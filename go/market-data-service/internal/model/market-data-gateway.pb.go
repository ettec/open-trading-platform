...
var fileDescriptor_ed5cefd53299cb80 = []byte{
	...
	0x9c, 0x93, 0x9f, 0x14, 0x08, 0x0a, 0x3c, 0x25, 0x06, 0x03, 0x46, 0x27, 0xf6, 0x28, 0x56, 0xb0,
	0x70, 0x12, 0x1b, 0x38, 0xdc, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xc2, 0x54, 0x62, 0x2a,
	0x8b, 0x01, 0x00, 0x00,
}
...
func (c *marketDataGatewayClient) Subscribe(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
func (*UnimplementedMarketDataGatewayServer) Subscribe(ctx context.Context, req *SubscribeRequest) (*Empty, error) {
