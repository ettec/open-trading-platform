...
func NewMarketDataSourceClient(id string, targetAddress string, out chan<- *model.ClobQuote,
	getConnection getMdsClientFn) (*mdsClient, error) {
...
func (mgc *mdsClient) Subscribe(listingId int32) {
